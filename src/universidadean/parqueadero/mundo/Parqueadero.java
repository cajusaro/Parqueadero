...
public class Parqueadero {
    ...
    /**
     * Es la el tamaño de horas que tiene un dia.
     */
     ...
     * Si la hora actual es igual a la hora maxima por dia, la hora actual retorna a 0.
     */
    public void avanzarHora() {

        horaActual++;

        if (horaActual > HORAS_POR_DIA)  horaActual = 0;
    ...
    public String metodo1() {
        ...
        /**
         * Tiempo maximo que lleva un carro en el parqueadero
         */
        int iTiempoParaqueado = 0;  //Mayor tiempo de un carro en el parqueadero.

        String sPlacaCarro = null;  //Placa carro con mas tiempo en el parqueadero.
        ...
        for (int i = 0; i < TAMANO; i++) {
            ...
            if (puestos[i].estaOcupado()){
                ...
                if (iTiempoTmp > iTiempoParaqueado){
                    iTiempoParaqueado = iTiempoTmp;
    ...
    public String metodo2() {
        ...
        if (iLibres == 0) retorno = "El parqueadero está lleno";
